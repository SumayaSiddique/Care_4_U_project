...
List<MenExerciseModel> beginnerAbs = [
  MenExerciseModel(
    title: 'plank ',
    description:
  ...
  MenExerciseModel(
    title: 'leg raises ',
    description:
        '   Lie faceup on the floor with your legs straight and your palms facing down. This is the starting position.  ' +
            '   Without bending your legs, lift them toward the ceiling until your hips just leave the floor. Then lower your legs down to the starting position again.   ' +
            '    ',
    type: 'abs',
    time: 'x16',
  ...
  MenExerciseModel(
    ...
    description: '   You will need an area where you can lay out your yoga mat.   ' +
  ...
  MenExerciseModel(
    ...
    gif: 'img/gifs/spineLumbarTwistStretchesLeft.gif',
  ),
  MenExerciseModel(
    title: 'heel touch ',
    description: '   •	Step 1: Lay down with your back on the ground and your knees bent and pointed towards the ceiling.   ' +
    ...
    gif: 'https://i.ibb.co/Qfh4Kzs/heel-Touch.gif',
    gifAvailable: true,
  ),
];
List<MenExerciseModel> intermediateAbs = [
  MenExerciseModel(
    title: 'spine lumbar twist stretches left ',
    description: '   You will need an area where you can lay out your yoga mat.   ' +
        '   1.	Lie down on your back.  ' +
  ...
  MenExerciseModel(
    ...
    type: 'abs',
    time: 'x12',
    image: 'img/AllImageData/none.jpg',
  ...
  MenExerciseModel(
    title: 'butt bridge ',
    description: '   How to do butt lift bridge step by step:  ' +
        '   •	Lie flat on your back with your hands by your sides and your knees bent so your feet are flat on the ground about hip width apart  ' +
  ...
  MenExerciseModel(
    title: 'V-up ',
    description: '   Lie faceup on the floor with your legs and arms straight.  ' +
  ...
  MenExerciseModel(
    ...
    description: '   To do the Bicycle Crunches Exercise:  ' +
  ...
  MenExerciseModel(
    ...
    description: '   Start by taking a nice deep breath and focusing on your abs.   ' +
    ...
    gif: 'https://i.ibb.co/q9LsLKM/crossover-Crunch.gif',
    gifAvailable: true,
  ),
  MenExerciseModel(
    title: 'mountain climber ',
  ...
  MenExerciseModel(
    ...
    description:
        '  Side plank is a great way to work both the obliques and the glutes. Lie on your left side, placing the left elbow on the floor directly under the shoulder. Keep the legs straight, with the right leg resting directly on top of the left. As you contract your waist and glutes, raise your hips and knees. Keep the left foot in contact with the floor. Hold for 5 to 20 seconds. Rest for 30 seconds and repeat. Then switch sides.  ',
    type: 'abs',
    time: '20s',
    image: 'img/AllImageData/sidePlankLeft.jpg',
    gif: 'https://i.ibb.co/Qcdhn9x/side-Plank.gif',
    gifAvailable: true,
  ),
  MenExerciseModel(
  ...
  MenExerciseModel(
    ...
    type: 'abs',
    time: 'x20',
    image: 'img/AllImageData/pushUpAndRotation.jpg', // Name change
...
List<MenExerciseModel> advancedAbs = [
  MenExerciseModel(
    title: 'push up and rotation ',
    description:
        '   Start at the top of the push up position with your hands on the floor, arms straight and underneath your shoulders. Step your feet back behind you and lift your knees. Engage your glutes, tense your legs and brace your core to keep your body rigid.  ' +
  ...
  MenExerciseModel(
    ...
    type: 'abs',
    time: 'x20',
    image: 'img/AllImageData/sitUps.jpg', // name change
...
// ARMS
List<MenExerciseModel> beginnerArm = [
  MenExerciseModel(
  ...
  MenExerciseModel(
    ...
    gif: 'https://i.ibb.co/6bpHjW8/inchworms.gif',
    gifAvailable: true,
  ),
  MenExerciseModel(
...
List<MenExerciseModel> intermediateArm = [
  MenExerciseModel(
    title: 'burpees',
    description:
  ...
  MenExerciseModel(
    ...
    time: '1 min',
    image: 'img/AllImageData/push-ups.jpg',
    gif: 'https://i.ibb.co/bz1Ctkx/pushUps.gif',
    gifAvailable: true,
  ),
  MenExerciseModel(
  ...
  MenExerciseModel(
    ...
    type: 'arm',
    time: '1 min',
    image: 'img/AllImageData/tricepsStretchLeft.jpg', // name change
  ...
  MenExerciseModel(
    ...
    type: 'arm',
    time: '1 min',
    image: 'img/AllImageData/armCirclesClockwise.jpg', // name change
    gif: 'img/gifs/armCirclesClockwise.gif',
  ),
  MenExerciseModel(
    title: 'leg barbell curl right ',
    description:
  ...
  MenExerciseModel(
    ...
    gif: 'https://i.ibb.co/Vg3W89p/floor-Triceps-Dips.gif',
    gifAvailable: true,
  ),
  MenExerciseModel(
    title: 'alternating hooks ',
...
List<MenExerciseModel> advancedArm = [
  MenExerciseModel(
    title: 'Standing biceps stretch left',
    description:
        '  This exercise stretches your biceps. Stand with your left arm close to a wall. Put your left hand on the wall and extend your arm. Gently turn your body to the right.    ',
  ...
  MenExerciseModel(
    ...
    type: 'arm',
    time: '1 min',
    image: 'img/AllImageData/modifiedPush-upLowHold.jpg', // name change
...
// CHEST
List<MenExerciseModel> beginnerChest = [
  MenExerciseModel(
  ...
  MenExerciseModel(
    ...
    time: '1 min',
    image: 'img/AllImageData/tricepsDips.jpg',
    gif: 'https://i.ibb.co/7yvLHGK/triceps-Dips.gif',
    gifAvailable: true,
  ),
  MenExerciseModel(
    title: 'push-ups ',
...
List<MenExerciseModel> intermediateChest = [
  MenExerciseModel(
    title: 'push-ups and rotation',
    description:
        '   Start at the top of the push up position with your hands on the floor, arms straight and underneath your shoulders. Step your feet back behind you and lift your knees. Engage your glutes, tense your legs and brace your core to keep your body rigid.  ' +
  ...
  MenExerciseModel(
    ...
    description: '   1. Start: Downward Dog  ' +
        '   Your body should look like a ‘V’ in downward dog to start. In this position, push your arms into the floor and drive your head towards your toes. You will feel your shoulders stabilize, your core tighten, and a stretch down your hamstrings and quads. This is your sign that you’re ready to start.  ' +
        '   2. Elbows  ' +
    ...
    gif: 'https://i.ibb.co/L1D0g90/hindu-Push-ups.gif',
    gifAvailable: true,
  ),
  MenExerciseModel(
    title: 'knee push-ups',
...
List<MenExerciseModel> advancedChest = [
  MenExerciseModel(
    title: 'push-ups and rotation',
    description:
        '   Start at the top of the push up position with your hands on the floor, arms straight and underneath your shoulders. Step your feet back behind you and lift your knees. Engage your glutes, tense your legs and brace your core to keep your body rigid.  ' +
  ...
  MenExerciseModel(
    ...
    time: '1 min',
    image: 'img/AllImageData/none.jpg',
    // image: 'img/AllImageData/armCircles.jpg',
    gif: 'img/gifs/armCircles.gif',
  ),
  MenExerciseModel(
    title: 'burpees',
    description:
  ...
  //   time: '1 min',
  //   image: 'img/AllImageData/none.jpg',
  //   // image: 'img/AllImageData/shoulderStretches.jpg',
  //   gif: 'img/gifs/shoulderStretches.gif',
  // ),
  MenExerciseModel(
    title: 'hindu push-ups',
    description: '   1. Start: Downward Dog  ' +
...
// LEG
List<MenExerciseModel> beginnerLeg = [
  MenExerciseModel(
    ...
    gif: 'https://i.ibb.co/yVtJ3qc/donkey-Kiks.gif',
    gifAvailable: true,
  ),
  MenExerciseModel(
  ...
  MenExerciseModel(
    ...
    gif: 'https://i.ibb.co/jy02QMx/sideHop.gif',
    gifAvailable: true,
  ),
  MenExerciseModel(
...
List<MenExerciseModel> intermediateLeg = [
  MenExerciseModel(
    title: 'Squats ',
    description: '   Here\'s a primer on how exactly to do the perfect squat.  ' +
        '   1.	Stand facing forward with your chest up.  ' +
  ...
  MenExerciseModel(
    ...
    description:
        'This exercise works your calves. Stand with your feet shoulder width apart, knees slightly bent and toes pointing outwards. Put your hands on the wall to maintain balance. Lift your heels up and down.    Please squeeze your calves when raising your heels. Exhale as you raise your heels, and inhale as you lower them.  ' +
            '',
    type: 'leg',
    time: '1 min',
    image: 'img/AllImageData/calfRaiseWithSplayedFoot.jpg', // name change
  ...
  MenExerciseModel(
    ...
    gif: 'https://i.ibb.co/BVzsNnB/fire-Hydrant.gif',
    gifAvailable: true,
  ),
  MenExerciseModel(
    title: 'Calf stretch left',
  ...
  MenExerciseModel(
    ...
    description:
        '   •	Step 1: Lie face down on a flat bench, positioning your hips on its edge. Your legs should be straight with your toes high off the floor with your arms on top of the bench. Hold onto the front edge.   ' +
            '   •	Step 2: Squeeze your glutes and hamstrings. Straighten your legs until they are level with your hips. This is the starting position.   ' +
...
List<MenExerciseModel> advancedLeg = [
  MenExerciseModel(
  ...
  MenExerciseModel(
    ...
    gif: 'https://i.ibb.co/RhZ9w4Q/glute-Kickback.gif',
    gifAvailable: true,
  ),
  MenExerciseModel(
    title: 'Bottom leg lift right',
  ...
  MenExerciseModel(
    ...
    gif: 'img/gifs/jumpingSquats.gif',
  ),
  MenExerciseModel(
  ...
  MenExerciseModel(
    ...
    type: 'leg',
    time: '1 min',
    image: 'img/AllImageData/wallResistingSingleLegCalfRaiseLeft.jpg',
    gif: 'img/gifs/wallResistingSingleLegCalfRaiseLeft.gif',
  ),
  MenExerciseModel(
    title: 'Left quad stretch with wall',
    description:
...
// SHOULDER
List<MenExerciseModel> beginnerShoulder = [
  MenExerciseModel(
    title: 'Knee push-ups',
    description:
        '  Start at the top of the push up position with your hands on the floor, arms straight and underneath your shoulders. Step your knees back behind you so that there is a straight line through your body from your knees up to your head. Engage your glutes, tense your legs and brace your core to keep your body rigid.  ',
  ...
  MenExerciseModel(
    title: 'Recline rhomboid squeezes',
    description:
        '   1.	Sit on the ground. Bend your knees and place flat feet on the ground. Lift your arms pointed in front of you. Slightly lean your torso back.  ' +
            '   2.	Bend your elbows until your forearms and upper arms form a sharp angle. Squeeze your shoulders and traps as much as you can.  ' +
            '   3.	Relax your shoulders and return your arms to the starting position. Repeat the exercise according to the training plan.  ' +
    ...
    // image: 'img/AllImageData/none.jpg',
    image: 'img/AllImageData/reclinedRhomboidSqueezes.jpg',
    gif: 'img/gifs/reclineRhomboidSqueezes.gif',
  ),
  MenExerciseModel(
    ...
    type: 'shoulder',
    time: '1 min',
    image: 'img/AllImageData/proneTricepsPushUps.jpg', // name change
...
List<MenExerciseModel> intermediateShoulder = [
  MenExerciseModel(
    ...
    gif: 'https://i.ibb.co/DC7C11B/triceps-Kickbacks.gif',
    gifAvailable: true,
  ),
  MenExerciseModel(
    title: 'Triceps kickbacks',
  ...
  MenExerciseModel(
    ...
    type: 'shoulder',
    time: '1 min',
    image: 'img/AllImageData/floorTricepsDip.jpg',
    gif: 'https://i.ibb.co/y61pN96/floor-Triceps-Dips.gif',
    gifAvailable: true,
  ),
  MenExerciseModel(
    title: 'Side-lying floor stretch left  ',
  ...
  MenExerciseModel(
    ...
    type: 'shoulder',
    time: '1 min',
    image: 'img/AllImageData/hoverPushUps.jpg', // name change
    gif: 'https://i.ibb.co/6sKHKkF/hover-Push-Ups.gif',
    gifAvailable: true,
  ),
];
List<MenExerciseModel> advancedShoulder = [
  MenExerciseModel(
    title: 'Jumping jacks',
    description:
        'Stand with your feet together and your hands at your sides. Simultaneously raise your arms above your head and jump up just enough to spread your feet out wide. Without pausing, quickly reverse the movement and repeat.',
  ...
  MenExerciseModel(
    ...
    gif: 'https://i.ibb.co/93mNwt2/hyperextension.gif',
    gifAvailable: true,
  ),
  MenExerciseModel(
    ...
    gif: 'https://i.ibb.co/Wf9BDt3/reverse-Push-ups.gif',
    gifAvailable: true,
  ),
  MenExerciseModel(
  ...
  MenExerciseModel(
    title: 'Side-lying floor stretches right',
    description:
        'Lie on your right side with your right knee slightly bent in front of you and your left leg stretched behind the right leg. Straighten your left arm over your head and gently pull on your left wrist to stretch the left side of your body. Hold this position for a few seconds. ',
    type: 'shoulder',
    time: '1 min',
    image: 'img/AllImageData/side-lyingFloorStretchesRight.jpg',
    gif: 'img/gifs/side-lyingFloorStretchesRight.gif',
  ),
  MenExerciseModel(
    title: 'Reverse push-ups',
    description: '   While performing this exercise, it\'s best to wear shoes with proper grip to prevent your feet from slipping.  ' +
  ...
  MenExerciseModel(
    ...
    time: '1 min',
    // image: 'img/AllImageData/none.jpg',
    image: 'img/AllImageData/floorY.jpg',
  ...
  MenExerciseModel(
    title: 'Side-lying floor stretches left',
    description:
        'Lie on your left side with your left knee slightly bent in front of you and your right leg stretched behind the left leg. Straighten your right arm over your head and gently pull on your right wrist to stretch the right side of your body. Hold this position for a few seconds. ',
    type: 'shoulder',
    time: '1 min',
    image: 'img/AllImageData/side-lyingFloorStretchesLeft.jpg',
    gif: 'img/gifs/side-lyingFloorStretchesLeft.gif',
  ),
  MenExerciseModel(
    title: 'Cat cow pose',
    description: '   1.	Start on all fours with shoulders over wrists and hips over knees. (Toes can be tucked or untucked.)   ' +
